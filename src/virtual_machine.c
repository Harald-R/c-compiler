...
unsigned int run(instr_t *IP)
{
    ...
    char *a1, *a2;
    char *FP = 0, *oldSP;
    unsigned int executed_instructions = 0;

    SP = stack;
    stack_after = stack + STACK_SIZE;

    while (1) {
        DEBUG_PRINTF("%p/%ld\t", IP, SP-stack);
        ...
        switch (IP->opcode) {
            ...
            case O_AND_I:
                i2 = popi();
                i1 = popi();
                DEBUG_PRINTF("AND_I\t(%ld AND %ld -> %d)\n", i1, i2, i1&&i2);
                pushi(i1&&i2);
                IP = IP->next;
                break;
            ...
            case O_GREATER_I:
                i2 = popi();
                i1 = popi();
                DEBUG_PRINTF("GREATER_I\t(%ld>%ld -> %d)\n", i1, i2, i1>i2);
                pushi(i1>i2);
                IP = IP->next;
                break;
            ...
            case O_GREATEREQ_C:
                c2 = popc();
                c1 = popc();
                DEBUG_PRINTF("GREATEREQ_C\t(%c>=%c -> %d)\n", c1, c2, c1>=c2);
                pushi(c1>=c2);
                IP = IP->next;
                break;
            ...
            case O_GREATEREQ_D:
                d2 = popd();
                d1 = popd();
                DEBUG_PRINTF("GREATEREQ_D\t(%g>=%g -> %d)\n", d1, d2, d1>=d2);
                pushi(d1>=d2);
                IP = IP->next;
                break;
            ...
            case O_GREATEREQ_I:
                i2 = popi();
                i1 = popi();
                DEBUG_PRINTF("GREATEREQ_I\t(%ld>=%ld -> %d)\n", i1, i2, i1>=i2);
                pushi(i1>=i2);
                IP = IP->next;
                break;
            ...
            case O_JF_A:
                a1 = popa();
                DEBUG_PRINTF("JF_A\t%p\t(%p)\n", IP->args[0].addr, a1);
                IP = !a1 ? IP->args[0].addr : IP->next;
                break;

            case O_JF_C:
                c1 = popc();
                DEBUG_PRINTF("JF_C\t%p\t(%c)\n", IP->args[0].addr, c1);
                IP = !c1 ? IP->args[0].addr : IP->next;
                break;

            case O_JF_D:
                d1 = popd();
                DEBUG_PRINTF("JF_D\t%p\t(%g)\n", IP->args[0].addr, d1);
                IP = !d1 ? IP->args[0].addr : IP->next;
                break;

            case O_JF_I:
                i1 = popi();
                DEBUG_PRINTF("JF_I\t%p\t(%ld)\n", IP->args[0].addr, i1);
            ...
            case O_JT_A:
                a1 = popa();
                DEBUG_PRINTF("JT_A\t%p\t(%p)\n", IP->args[0].addr, a1);
                IP = a1 ? IP->args[0].addr : IP->next;
                break;

            case O_JT_C:
                c1 = popc();
                DEBUG_PRINTF("JT_C\t%p\t(%c)\n", IP->args[0].addr, c1);
                IP = c1 ? IP->args[0].addr : IP->next;
                break;

            case O_JT_D:
                d1 = popd();
                DEBUG_PRINTF("JT_D\t%p\t(%g)\n", IP->args[0].addr, d1);
                IP = d1 ? IP->args[0].addr : IP->next;
                break;

            case O_JT_I:
                i1 = popi();
                DEBUG_PRINTF("JT\t%p\t(%ld)\n", IP->args[0].addr, i1);
                IP = i1 ? IP->args[0].addr : IP->next;
                break;
            ...
            case O_OFFSET_I:
                i1 = popi();
                a1 = popa();
                DEBUG_PRINTF("OFFSET_I\t(%p+%ld -> %p)\n", a1, i1, a1 + i1*sizeof(long int));
                pusha(a1 + i1*sizeof(long int));
                IP = IP->next;
                break;
